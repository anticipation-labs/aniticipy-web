...
const scriptVersion = createHash("sha256")
  .update(await readFile("dist/assets/site.js"))
  .digest("hex")
  .slice(0, 12);
const styleVersion = createHash("sha256")
  .update(await readFile("dist/assets/site.css"))
  .digest("hex")
  .slice(0, 12);
const document = (content, campaign = false) =>
  `<!doctype html><html lang="en"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width, initial-scale=1"><meta name="theme-color" content="#ffffff"><meta name="robots" content="noindex"><title>Anticipy: Not a note taker. An action taker.</title><meta name="description" content="Meet Anticipy, the titanium AI pendant that turns the things you say into the things you get done."><meta property="og:title" content="Anticipy: Not a note taker. An action taker."><meta property="og:description" content="A quiet companion for a beautifully busy life."><meta property="og:image" content="/og.png"><link rel="icon" href="/icon.svg"><link rel="preload" href="/redesign/fonts/dm-sans-regular.ttf" as="font" type="font/ttf" crossorigin><link rel="stylesheet" href="/assets/site.css?v=${styleVersion}"><style>html{scroll-behavior:auto}body{margin:0}button,input{font:inherit}@media(prefers-reduced-motion:reduce){html{scroll-behavior:auto}}</style></head><body><div id="root">${content}</div><script type="module" src="/assets/site.js?v=${scriptVersion}"></script></body></html>`;
